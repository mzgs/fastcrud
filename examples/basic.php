        ...
        <div class="row justify-content-center">
         ...
         <div class="col">
                ...
                $postsCrud
                    ...
                    ->columns('user_id,title,slug,is_featured,content,created_at,image,gallery_images')
                    ->fields('user_id,title,is_featured,image,gallery_images,content,created_at', false, 'Post Details' )
                  ...
                  ->column_pattern('image', '<img src="/public/uploads/{value}" alt="Image" style="max-height: 100px; max-width: 100px; object-fit: contain;" />')
