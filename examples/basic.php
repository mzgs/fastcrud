         ...
         <div class="col">
                ...
                $postsCrud
                    ...
                    ->add_multi_link_button([
                        ...
                        ['url' => '/customers/{id}', 'label' => 'Profile', 'icon' => 'fas fa-user'],
                        ['url' => '/customers/{id}/overview', 'label' => 'Overview', 'icon' => 'fas fa-chart-pie'],
                        ['url' => '/customers/{id}/activity', 'label' => 'Activity', 'icon' => 'fas fa-bolt'],
                        ['url' => '/customers/{id}/notes', 'label' => 'Notes', 'icon' => 'fas fa-sticky-note'],
                        ['url' => '/customers/{id}/billing', 'label' => 'Billing', 'icon' => 'fas fa-credit-card'],
                        ['url' => '/customers/{id}/invoices', 'label' => 'Invoices', 'icon' => 'fas fa-file-invoice'],
                        ['url' => '/customers/{id}/payments', 'label' => 'Payments', 'icon' => 'fas fa-money-bill'],
                        ['url' => '/customers/{id}/subscriptions', 'label' => 'Subscriptions', 'icon' => 'fas fa-sync'],
                        ['url' => '/customers/{id}/settings', 'label' => 'Settings', 'icon' => 'fas fa-sliders-h'],
                        ['url' => '/customers/{id}/security', 'label' => 'Security', 'icon' => 'fas fa-shield-alt'],
                        ['url' => '/customers/{id}/teams', 'label' => 'Teams', 'icon' => 'fas fa-users'],
                        ['url' => '/customers/{id}/members', 'label' => 'Members', 'icon' => 'fas fa-user-friends'],
                        ['url' => '/customers/{id}/api-keys', 'label' => 'API Keys', 'icon' => 'fas fa-key'],
                        ['url' => '/customers/{id}/integrations', 'label' => 'Integrations', 'icon' => 'fas fa-plug'],
                        ['url' => '/customers/{id}/exports', 'label' => 'Exports', 'icon' => 'fas fa-file-export'],
                        ['url' => '/customers/{id}/imports', 'label' => 'Imports', 'icon' => 'fas fa-file-import'],
                        ['url' => '/customers/{id}/alerts', 'label' => 'Alerts', 'icon' => 'fas fa-bell'],
                        ['url' => '/customers/{id}/tasks', 'label' => 'Tasks', 'icon' => 'fas fa-tasks'],
                        ['url' => '/customers/{id}/logs', 'label' => 'Logs', 'icon' => 'fas fa-clipboard-list'],
                        ['url' => '/customers/{id}/sessions', 'label' => 'Sessions', 'icon' => 'fas fa-history'],
                        ['url' => '/customers/{id}/support', 'label' => 'Support', 'icon' => 'fas fa-life-ring'],
                        ['url' => '/customers/{id}/feedback', 'label' => 'Feedback', 'icon' => 'fas fa-comment-dots'],
                        ['url' => '/customers/{id}/changelog', 'label' => 'Changelog', 'icon' => 'fas fa-scroll'],
                        ['url' => '/customers/{id}/audit', 'label' => 'Audit', 'icon' => 'fas fa-user-shield'],
                        ['url' => '/customers/{id}/archive', 'label' => 'Archive', 'icon' => 'fas fa-archive'],
                        ['type' => 'divider' ],
                    ...
                    // ->fields('user_id,status,title,is_featured,json_field,image,gallery_images, bfile,color,content,created_at'  )
